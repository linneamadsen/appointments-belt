...
def appointments(request):
    ...
    #     b = datetime.strptime(a.due_date, '%Y-%m-%d')
    #     # c = datetime.strptime(time_now, '%Y-%m-%d')
    #     print b, "from appointments"
    #     print type(b)
        # print c
...
def add_appointment(request):
    ...
    appointment = Appointment.objects.create(description=description, due_date=due_date, status=status, user_id=user_id)
